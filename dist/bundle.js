(function (exports, React, http, https, url, stream, assert, tty, util, os, zlib) {
  'use strict';
...
}({}, React, http, https, url, stream, assert, tty, util, os, zlib));
